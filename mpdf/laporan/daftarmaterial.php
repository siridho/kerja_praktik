...
$html.="<h4 style='text-align:center;'>Daftar Material</h4>
...
$sqldaftaralat = "SELECT ada.kode as kode, a.kelompok as kelompok, ada.harga as harga, a.nama as namaalat, a.satuan as satuan FROM daftarmaterial da inner join material_daftarmaterial ada on da.id=ada.iddaftarmaterial INNER JOIN material a ON a.kode=ada.kode WHERE da.idproyek=".$id." and ada.iddaftarmaterial=(select max(dd.id) from daftarmaterial dd where dd.idproyek=".$id.")";
$no=1;
...
$html.=		"<tr>
		...
		<td style='text-align:center;'>".$baris1['kelompok']."</td>
